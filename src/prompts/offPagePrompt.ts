// src/prompts/offPagePrompt.ts
// Prompt builders for off_page (SEO off-page article) content type.
// Currently mirrors on_blog prompts — customize this file to differentiate off_page content.

import type { ContentStage, LocationContext } from '../types';

export interface OffPageImagePromptParams {
  articleTitle: string;
...
export interface OffPageOutlinePromptParams {
  masterPrompt: string;
...
export interface OffPageSectionPromptParams {
  masterPrompt: string;
  langNameNative: string;
  sectionTitle: string;
...
export function buildOffPageOutlinePrompt(params: OffPageOutlinePromptParams): string {
...
export function buildOffPageSectionPrompt(params: OffPageSectionPromptParams): string {
  const {
    masterPrompt,
    langNameNative,
    sectionTitle,
...
export function buildOffPageImagePrompt(params: OffPageImagePromptParams): string {
